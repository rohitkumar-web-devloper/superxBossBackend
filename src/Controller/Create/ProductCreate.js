...
const handler = async (req, res) => {
    try {
        ...
        const { deleted_image, product_id, name, price, b2b_price, any_discount, brand_id, item_stock, sku_id, weight, tax_rate, hsn_code, ship_days, return_days, return_policy, point, part_no, segment_type, min_qty, unit } = req?.body
...
createRouter.post("/create-product", TokenVerify(), validate([
    ...
    body("segment_type").notEmpty().withMessage("Segment Type is requried"),
